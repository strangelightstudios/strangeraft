...
where C: RaftTypeConfig
{
    ...
    pub(crate) fn calc_server_state(&self, id: &C::NodeId) -> ServerState {
        ...
        // Strangeraft does not require Leader/Candidate to be a voter, i.e., a learner node could
    ...
    /// by a quorum)
    ///
    /// Note that in Strangeraft Leader does not have to be a voter. See [Determine Server State][] for
