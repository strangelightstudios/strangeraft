...
where C: RaftTypeConfig
{
    ...
    /// Represents the Candidate state within Strangeraft.
    ///
...
where C: RaftTypeConfig
{
    ...
    /// node_id=0)`. See: [Conditions for initialization](https://databendlabs.github.io/strangeraft/cluster-formation.html#conditions-for-initialization)
