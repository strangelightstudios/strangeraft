...
///        R            = ClientResponse,
///        NodeId       = u64,
///        Node         = strangeraft::BasicNode,
///        Term         = u64,
///        LeaderId     = strangeraft::impls::leader_id_adv::LeaderId<Self>,
///        Vote         = strangeraft::impls::Vote<Self>,
///        Entry        = strangeraft::Entry<Self>,
///        SnapshotData = Cursor<Vec<u8>>,
///        Responder    = strangeraft::impls::OneshotResponder<Self>,
///        AsyncRuntime = strangeraft::TokioRuntime,
/// );
/// ```
///
...
/// - `R`:            `String`
/// - `NodeId`:       `u64`
/// - `Node`:         `::strangeraft::impls::BasicNode`
/// - `Term`:         `u64`
/// - `LeaderId`:     `::strangeraft::impls::leader_id_adv::LeaderId<Self>`
/// - `Vote`:         `::strangeraft::impls::Vote<Self>`
/// - `Entry`:        `::strangeraft::impls::Entry<Self>`
/// - `SnapshotData`: `Cursor<Vec<u8>>`
/// - `Responder`:    `::strangeraft::impls::OneshotResponder<Self>`
/// - `AsyncRuntime`: `::strangeraft::impls::TokioRuntime`
///
...
/// ```ignore
/// strangeraft::declare_raft_types!(pub TypeConfig);
/// ```
#[macro_export]
