# Strangeraft Document

If you're starting to build an application with Strangeraft, check out
- [`getting_started`](crate::docs::getting_started).
- [`faq`](crate::docs::faq),

To maintain an Strangeraft cluster, e.g., add or remove nodes, refer to
...
When upgrading an Strangeraft application, consult:
...
To learn about the data structures used in Strangeraft and the commit protocol, see
- [`feature_flags`](crate::docs::feature_flags);
- [`data`](crate::docs::data) :
  - [`Vote`](`crate::docs::data::vote`) is the core in a distributed system;
  - [`Log pointers`](`crate::docs::data::log_pointers`) shows how Strangeraft tracks entries in the log;
  - [`Leader lease`](`crate::docs::data::leader_lease`) explains leader lease for a Leader and a Follower;
  - [`Extended membership`](`crate::docs::data::extended_membership`) explains how members are organized in Strangeraft;
  - [`Effective membership`](`crate::docs::data::effective_membership`) explains when membership config takes effect;
- [`components`](`crate::docs::components`) explains the components in Strangeraft;
...
Contributors who want to understand the internals of Strangeraft can find relevant information in
- [`internal`](crate::docs::internal) :
  - [Architecture](`crate::docs::internal::architecture`) shows the overall architecture of Strangeraft;
  - [Threading](`crate::docs::internal::threading`) describes the threading model of Strangeraft;
