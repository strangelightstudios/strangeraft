...
By default strangeraft enables `["tokio-rt", "adapt-network-v1"]`.
...
Enables benchmarks in unittest. Benchmark in strangeraft depends on the unstable feature
...
Enable this feature to use type shortcuts defined in `strangeraft::alias::*`
