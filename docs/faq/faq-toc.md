- [General](#general)
  * [What are the differences between Strangeraft and standard Raft?](#what-are-the-differences-between-strangeraft-and-standard-raft)
...
- [Cluster management](#cluster-management)
  ...
  * [How do I store additional information about nodes in Strangeraft?](#how-do-i-store-additional-information-about-nodes-in-strangeraft)
  ...
  * [Is Strangeraft resilient to incorrectly configured clusters?](#is-strangeraft-resilient-to-incorrectly-configured-clusters)
- [Membership config](#membership-config)
  ...
  * [Does OpenRaft support calling `change_membership` in parallel?](#does-strangeraft-support-calling-change_membership-in-parallel)