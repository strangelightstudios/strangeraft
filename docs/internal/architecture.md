# Strangeraft Architecture

The Strangeraft architecture is designed to provide a modular and extensible
...
The major components inside Strangeraft include:

- **[`Raft`]**: This is the control handle for the application and user. It
  provides APIs to send `RaftMsg` to `RaftCore` to manipulate Strangeraft.
